...
module.exports = ({
  ...
  return {
    name: "@theme-yiliang114/vuepress-plugin-blog",
    ...
    extendPageData($page) {
      ...
      if ($page.path.startsWith(ensureBothSlash(postsDir))) {
        ...
        $page.createdAt = $page.frontmatter.date
          ? format($page.frontmatter.date, "YYYY-MM-DD")
          : null;
        $page.updatedAt = $page.lastUpdated
          ? format($page.lastUpdated, "YYYY-MM-DD")
          : null;
      }
    },
