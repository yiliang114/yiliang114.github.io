...
![1x.png](https://s0.lgstatic.com/i/image/M00/33/8E/Ciqc1F8QQIOAeb5wAACpWwM8kyw558.png)
...
但要注意的是，只能把 document.domain 设置成更高级的父域才有效果，例如在   [http://kaiwu.lagou.com/child.html](http://kaiwu.lagou.com/child.html) 中可以将 document.domain 设置成  kaiwu.lagou.com。
