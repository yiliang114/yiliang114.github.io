...
![audits](https://wire.cdn-go.cn/wire-cdn/b23befc0/blog/images/aduits.png)

选择想测试的功能然后点击 Run audits ，工具就会自动运行帮助我们测试问题并且给出一个完整的报告。
![报告](https://wire.cdn-go.cn/wire-cdn/b23befc0/blog/images/aduitsReport.png)

可以看到报告中分别为**性能、体验、SEO** 都给出了打分，并且每一个指标都有详细的评估。

评估结束后，工具还提供了一些建议便于我们提高这个指标的分数。
![建议](https://wire.cdn-go.cn/wire-cdn/b23befc0/blog/images/auditsSuggest.png)

还有一个 Performance 工具也可以供我们使用。
![performance](https://wire.cdn-go.cn/wire-cdn/b23befc0/blog/images/performance.png)
