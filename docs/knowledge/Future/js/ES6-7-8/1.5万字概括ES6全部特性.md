...
![ES2016](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1118" height="532"></svg>)
...
![ES2017](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="990"></svg>)
...
![ES2018](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="1100"></svg>)
...
![ES2019](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="1116"></svg>)
...
![ES提案](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="693" height="1280"></svg>)
...
写到最后总结得差不多了，后续如果我想起还有哪些**ES6 特性**遗漏的，会继续在这篇文章上补全，同时也希望各位朋友对文章里的要点进行补充或者提出自己的见解。欢迎在下方进行评论或补充喔，喜欢的**点个赞**或**收个藏**，保证你在开发时用得上。

最后送大家一张完整的 ES6 特性图，记得给我**点个赞**喔，算是对我一种鼓励啦，哈哈！
