...
![Audits 所处位置](../js/images/16772c479b194d48.jpg)

点我们点击 Audits 后，可以看到如下的界面

![Audits 界面](../js/images/16772c52e83d97c7.jpg)

在这个界面中，我们可以选择想测试的功能然后点击 **Run audits** ，工具就会自动运行帮助我们测试问题并且给出一个完整的报告

![Audits 工具给出的报告](../js/images/16772ca3d13a68ab.jpg)

上图是给掘金首页测试性能后给出的一个报告，可以看到报告中分别为**性能、体验、SEO** 都给出了打分，并且每一个指标都有详细的**评估**

![指标中的详细评估](../js/images/16772cae50f7eb81.jpg)

评估结束后，工具还提供了一些**建议**便于我们提高这个指标的分数

![优化建议](../js/images/16772cbdcdaccf15.jpg)

我们只需要一条条根据建议去优化性能即可。

除了 **Audits** 工具之外，还有一个 **Performance** 工具也可以供我们使用。

![Performance 工具给出的报告](../js/images/16772cf78a4fa18f.jpg)
...
![img](../js/images/16773b904cfb732f.jpg)
...
![优化与不优化代码之间的巨大差距](../js/images/16778338eb8b7130.jpg)
