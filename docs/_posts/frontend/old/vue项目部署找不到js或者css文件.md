...
![](https://chatflow-files-cdn-1252847684.file.myqcloud.com/20190105154109600.png)
...
![](https://chatflow-files-cdn-1252847684.file.myqcloud.com/20190105153832561.png)

非 `production` mode 下，是在`config/index.js` 中设置的，这里的 `publicPath` 默认是
![](https://chatflow-files-cdn-1252847684.file.myqcloud.com/20190105153930278.png)
